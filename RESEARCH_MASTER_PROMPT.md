...
Your objective is to produce a deeply researched, evidence-backed strategic foundation for Hypenex that will later be converted into an investor-ready Strategy Bible and pitch deck.
...
5. Why might customers reject this?
6. Why might competitors already solve this?
...
After every meaningful research sub-step and After every meaningful research sub-step and at the end of every completed stage (after it passes Red Team review), output a "SESSION STATE UPDATE" block and save it to `SESSION_STATE.md`, containing:
...
Understand the market environment in which Hypenex operates.
...
- Does Hypenex actually differentiate?
...
Understand the people Hypenex serves and validate the problem being solved.
